...
<body>
    ...
    <form>
        <table>
            ...
            <tr>
                <td>
                    <input type="text" readonly disabled value="<?php echo $row["section"];?>">
                </td>
                <td>
                    <input type="text" readonly disabled value="<?php echo $row["department"];?>">
                </td>
                <td>
                    <input type="text" readonly disabled value="<?php echo $row["position"];?>">
                </td>
                <td>
                    <input type="text" readonly disabled value="<?php echo $row["startDate"];?>">
                </td>
            </tr>
        </table>
    </form>
